...
/*PIANETA SIMPLEX*/
function E3_CreateSimplexPlanetGeom(Obj) {
...
/*----------------------------------------------1 CREATION ENGINE 2775 (12912-10846=2066)------------------------------------------------------*/
...
export async function MicEngine(Parameters, OggettiObj, GeometrieObj, MaterialiObj) {
   ...
   MicEnginereturn.Geometries = {
      ...
      E3_CreateSimplexPlanetGeom: E3_CreateSimplexPlanetGeom,
   };
...
export async function SnippetEngine() {
   ...
   //PIANETA SIMPLEX
   //#region
   const PlanetGeom = E3_CreateSimplexPlanetGeom({
